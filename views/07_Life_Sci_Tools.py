"""
Life Sci Tools / Dx / Bioprocessing comp table.
"""
...
st.title("Life Sci Tools / Dx / Bioprocessing")
...
try:
    data = db.get_latest_snapshots(segment="life_sci_tools")
    render_comp_table(data, "Life Sci Tools / Dx / Bioprocessing")
